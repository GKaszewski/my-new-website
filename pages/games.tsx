...
const unityContext = new UnityContext({
	...
	dataUrl: "https://gabrielkaszewski.dev/media/Builds.data",
	frameworkUrl: "https://gabrielkaszewski.dev/media/Builds.framework.js",
	codeUrl: "https://gabrielkaszewski.dev/media/Builds.wasm",
});
